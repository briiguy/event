...
var getFullNames=function(input){
    var newArray=[]
    for(var i=0;i<customers.length;i++){
        newArray[i]= customers[i].first+" "+customers[i].last
        }
return newArray
...
var pluck=function(objects,property){

var array=[]
        for(var i=0;i<objects.length;i++){
            array.push(objects[i][property])
        }
return array
...
var wordArray=input.toLowerCase().split(" ")
    ...
    for(var i=0;i<wordArray.length;i++){
        ...
        if (object[wordArray[i]]>0){object[wordArray[i]]=object[wordArray[i]]+1}
        else{object[wordArray[i]]=1}
